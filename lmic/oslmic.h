...
#ifdef QUARK_BUILD
    #define table_get_u1(table, index) ((u1_t)(((const u1_t *)(table))[((size_t)(index))]))
    #define table_get_s1(table, index) ((s1_t)(((const s1_t *)(table))[((size_t)(index))]))
    #define table_get_u2(table, index) ((u2_t)(((const u2_t *)(table))[((size_t)(index))]))
    #define table_get_s2(table, index) ((s2_t)(((const s2_t *)(table))[((size_t)(index))]))
    #define table_get_u4(table, index) ((u4_t)(((const u4_t *)(table))[((size_t)(index))]))
    #define table_get_s4(table, index) ((s4_t)(((const s4_t *)(table))[((size_t)(index))]))

    #define table_get_ostime(table, index) ((ostime_t)(((const ostime_t *)(table))[((size_t)(index))]))
#endif
